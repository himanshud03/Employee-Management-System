      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2">
              Project Maintainer:{' '}
              <Link href="https://github.com/himanshud03" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f57c00' } }}>
                Himanshu
              </Link>
            </Typography>
            <Typography variant="body2">
              Email:{' '}
              <Link href="mailto:hdurgwar5@gmail.com" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f57c00' } }}>
                hdurgwar5@gmail.com
              </Link>
            </Typography>
            <Typography variant="body2">Phone: +91 702021__62</Typography>
